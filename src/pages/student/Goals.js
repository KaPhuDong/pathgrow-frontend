          ...
          <div className="card-body">
            <div className="mb-4">
              ...
              <p className="card-text text-muted">
                After the semester, what exactly would I like to be able to do in the language?
              </p>
            </div>
            ...
            <div className="table-responsive">
              <table className="table table-bordered">
                <thead>
                  <tr>
                    <th colSpan={4} className="text-center text-white" style={{ backgroundColor: "#7BC043" }}>
                      SEMESTER 1
                    </th>
                  </tr>
                ...
                <tbody>
                  <tr>
                    <td className="table-light"><strong>What I expect from the course?</strong></td>
                    <td>
                      <textarea
                        className="form-control"
                        rows="2"
                        value={inputs.expectCourse.it}
                        onChange={(e) => handleChange("expectCourse", "it", e.target.value)}
                      />
                    </td>
                    <td>
                      <textarea
                        ...
                        onChange={(e) => handleChange("expectCourse", "toeic", e.target.value)}
                      />
                    </td>
                    <td>
                      <textarea
                        ...
                        onChange={(e) => handleChange("expectCourse", "comm", e.target.value)}
                      />
                    </td>
                  </tr>
                  <tr>
                    <td className="table-light"><strong>What I expect from the teacher & instructor?</strong></td>
                    <td>
                      <textarea
                        className="form-control"
                        rows="2"
                        value={inputs.expectTeacher.it}
                        onChange={(e) => handleChange("expectTeacher", "it", e.target.value)}
                      />
                    </td>
                    <td>
                      <textarea
                        ...
                        onChange={(e) => handleChange("expectTeacher", "toeic", e.target.value)}
                      />
                    </td>
                    <td>
                      <textarea
                        ...
                        onChange={(e) => handleChange("expectTeacher", "comm", e.target.value)}
                      />
                    </td>
                  </tr>
                  <tr>
                    <td className="table-light"><strong>What I expect from myself?</strong></td>
                    <td>
                      <textarea
                        className="form-control"
                        rows="2"
                        value={inputs.expectMyself.it}
                        onChange={(e) => handleChange("expectMyself", "it", e.target.value)}
                      />
                    </td>
                    <td>
                      <textarea
                        ...
                        onChange={(e) => handleChange("expectMyself", "toeic", e.target.value)}
                      />
                    </td>
                    <td>
                      <textarea
                        ...
                        onChange={(e) => handleChange("expectMyself", "comm", e.target.value)}
                      />
                    </td>
                  </tr>
                </tbody>
